...
for i in range(3):
    ...
    pw_file = open("Project_Strart\\Feature\\password.txt", "r")
    pw = pw_file.read()
    pw_file.close()
    if (a == pw):
        print("  ")
...
def takeCommand():
    ...
    with speech_recognition.Microphone() as source:
        ...
        audio = r.listen(source,0,3)  #har 4 sec ma listening kara ga 
    try:
           print(" ")
           print("Understanding......")
        ...
        if "wake up" in query:
            ...
            while True:
                ...
                if"go to sleep" in query:
                    ...
                    speak("I am your prsonal AI Assistant")
                elif "Who are you" in query:
                    speak("I am your prsonal AI Assistant")
                elif "What is your name" in query:
                    speak("My name is JAN")
                elif "who creat you" in query:
                    speak("Ayush Pallaw creat me sir")
...
##################################################################################################################
                    ...
                    speak("That's very generous of you, I will keep improving myself")
            ...
            #WhatsApp Automations
                    ...
                    speak("Whatsapp Message automation start sir")
                    from WhatsAppAutomation.WhatsappMessages import WhatsappMsg  
                    WhatsappMsg('whatsapp','ayush','hii ayush sb thik hai na') 
                elif "voice call" in query:
                    speak("Whatsapp Audiocall automation start sir")
                    from WhatsAppAutomation.AudioCall import WhatsappCall
                    WhatsappCall('whatsapp', 'ayush')  
                elif"video call" in query:
                    speak("Whatsapp videocall automation start sir")
                    from WhatsAppAutomation.VideoCall import WhatsappVideo
                    WhatsappVideo('whatsapp', 'ayush') 

            #Searching Automatons
            ...
            #Temperature and werather automations
